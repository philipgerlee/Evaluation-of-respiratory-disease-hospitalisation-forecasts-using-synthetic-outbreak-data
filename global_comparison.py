...
if __name__ =='__main__':
    ...
    # write results :
    reach=7
    with open('./results/global_evaluation/evaluation_with_RMSE_of_3D_models_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'_and_reach_='+str(reach)+'.json', 'w') as f:
            json.dump(dico_rmse_3D_reach_7, f)

    with open('./results/global_evaluation/evaluation_with_WIS_of_3D_models_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'_and_reach_='+str(reach)+'.json', 'w') as f:
            json.dump(dico_wis_3D_reach_7, f)

    with open('./results/global_evaluation/evaluation_with_RMSE_of_1D_models_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'_and_reach_='+str(reach)+'.json', 'w') as f:
            json.dump(dico_rmse_1D_reach_7, f)

    with open('./results/global_evaluation/evaluation_with_WIS_of_1D_models_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'_and_reach_='+str(reach)+'.json', 'w') as f:
    ...
    df_results_7_quant.to_csv('./results/predictions_of_the_models/quantiles_7_days_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'.csv')
    df_results_14_quant.to_csv('./results/predictions_of_the_models/quantiles_14_days_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'.csv')
