...
freq_range = range(1,32,5)

# Generate all combinations of mob_of_the_pandemic and number_of_the_pandemic
tasks = [(mob, num, freq) for mob in mobility_range for num in number_range for freq in freq_range]
...
def run_task(task):
    ...
    command = [
        "python",
        "thinning_comparison.py",  # Replace with your script's filename
        str(mob),
        str(num),
        str(freq),
    ]
    print(f"Running for mob_of_the_pandemic={mob}, number_of_the_pandemic={num}, frequency={freq}")
