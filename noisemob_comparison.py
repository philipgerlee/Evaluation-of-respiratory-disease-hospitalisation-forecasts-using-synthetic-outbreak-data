...
if __name__ =='__main__':
    ...
    mobility_n= mobility.copy()+np.random.normal(0, noise, len(mobility))
    data3D=np.array([n_hospitalized, n_infectious, mobility_n])
    ...
    #with open('./results/thinning_evaluation/evaluation_with_RMSE_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'_and_reach_='+str(reach)+'_noisemob_='+str(noise)+'.json', 'w') as f:
    #        json.dump(dico_rmse, f)
    #print('test')
    with open('./results/thinning_evaluation/evaluation_with_WIS_on_pandemic_'+str(mob_of_the_pandemic)+'_'+str(number_of_the_pandemic)+'_and_reach_='+str(reach)+'_noisemob_='+str(noise)+'.json', 'w') as f:
